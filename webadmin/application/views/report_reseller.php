...
<html>
		...
		<div class="table-container">
			...
			<div class="ui top attached menu">
			  	<div class="ui dropdown icon item">
				    Options
				    <div class="menu">
			      		<a href="<?= base_url(); ?>report/export_reseller/<?= $date_start; ?>/<?= $date_end; ?>/" class="item">Export to Excel</a>
						<a href="<?= base_url(); ?>report/reseller/<?= $date_start; ?>/<?= $date_end; ?>/" class="item">Refresh Page</a>
			    	</div>
				</div>
	...
	<script type="text/javascript">
		...
		function reload() {
			...
			window.location.href = '<?= base_url(); ?>report/reseller/'+ dateStart +'/'+ dateEnd +'/';
		}
