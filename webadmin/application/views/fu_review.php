...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="ui breadcrumb">
				...
				<div class="active section">Follow Up Order</div>
			</div>
		</div>
		...
		<div class="table-container">
			...
			<div class="ui top attached menu">
			  	<div class="ui dropdown icon item">
				    Options
				    <div class="menu">
						<a href="<?= base_url(); ?>followup/review/<?= $page; ?>/" class="item">Refresh Page</a>
			    	</div>
				</div>
						...
						<? if (count($arr_order) > 0): ?>
							<? foreach ($arr_order as $order): ?>
								<tr>
									...
									<td><?= $order->date_follow_up_display; ?></td>
	...
	<script type="text/javascript">
		...
		function changePage(page) {
			window.location.href = '<?= base_url(); ?>followup/review/'+ page +'/';
		}
			...
			$.ajax({
				...
				success: function(data){
					if (data.status == 'success') {
						...
						window.open('https://api.whatsapp.com/send?phone='+ phone +'&text=Hi%20kak,%0A%0ASelamat%20kamu%20sudah%20berani%20buat%20*%23UpgradeYourself*%20dengan%20produk%20Norm%20demi%20penampilan%20yang%20oke%20dan%20prima.%0A%0AFeedback%20dari%20kamu%20penting%20banget%20nih%20soal%20produk%20Norm,%20terutama%20experience%20kamu%20pakai%20produk%20baru%20Norm%20di%20wajah,%20tubuh,%20atau%20rambut.%0AReview%20yang%20paling%20menarik%20bakal%20Norm%20kasih%20voucher%20*DISKON%2010%*%20buat%20semua%20produk%20untuk%20pembelian%20berikutnya.%0A%0ABoleh%20tau%20kak,%20gimana%20pengalaman%20kakak%20pakai%20produk%20Norm?', '_blank');
