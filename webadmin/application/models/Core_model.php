...
class Core_model extends CI_Model
{
	...
	{
		$user_id = (isset($record['author_id'])) ? $record['author_id'] : $this->session->userdata('user_id');
		$user_name = (isset($record['author_name'])) ? $record['author_name'] : $this->session->userdata('user_name');
