...
<body>
				...
				<div class="col-12 col-sm-6 small-gap">
					<div class="image">
						<div class="product-image-carousel owl-carousel owl-theme">
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/ultimate-gift-set-1.jpg">
							</div>
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/ultimate-gift-set-2.jpg">
							</div>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						...
						<div class="description">
							...
							<p>Dapatkan Box Premium dari Norm sebagai bentuk hadiah spesial bagi orang yang berada di sekitar kamu. Eksklusif, Kuat, Gentleman.</p>
						</div>
						...
						<!-- <div class="button">
							<button class="main width-100 cart-33" onclick="addToCart(33, 0, 1, 659000);">Add to Cart</button>
						</div> -->
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="33" data-price="659000" data-currency="IDR" data-name="Ultimate Gentleman Set" data-url="https://www.norm.id/ultimate-gift-set/" data-image-url="<?= base_url(); ?>assets/images/main/product/ultimate-gift-set-1.jpg"></div>
		</div>
	</section>
