...
<body>
			...
			<div class="row product-container small-gap margin-top-30px">
				<div class="col-12 col-sm-6 small-gap">
					<div class="image">
						<div class="product-image-carousel owl-carousel owl-theme">
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/complete-maintenance-set-square.jpg">
							</div>
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/complete-maintenance-set-square-2.jpg">
							</div>
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/complete-maintenance-set-square-3.jpg">
							</div>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						<h1 class="title">Ultimate Gentleman Set</h1>

						<div class="yotpo bottomLine margin-top-15px" data-appkey="ZDXRDls8ly8DXaihaUvajdNv4AFIlQSvKN1Ee3zP" data-domain="https://www.norm.id/" data-product-id="23" data-product-models="Bundle" data-name="Ultimate Gentleman Set" data-url="https://www.norm.id/complete-set/" data-image-url="<?= base_url(); ?>assets/images/main/product/complete-maintenance-set-square.jpg" data-description="Ultimate Gentleman Set adalah pilihan tepat dan lengkap untuk kamu mendapatkan penampilan yang lebih segar dan harum serta wajah bersih yang bersih, cerah, dan tampak lebih muda." data-bread-crumbs="Bundle"></div>

						<div class="price">IDR 459.000</div>

						<div class="description">
							<p>Ultimate Gentleman Set adalah pilihan tepat dan lengkap untuk kamu mendapatkan penampilan yang lebih segar dan harum serta wajah bersih yang bersih, cerah, dan tampak lebih muda.</p>
						</div>
						...
						<!-- <div class="button">
							<button class="main width-100 cart-23" onclick="addToCart(23, 0, 1, 459000);">Add to Cart</button>
						</div> -->
							...
							<div class="row small-gap e-commerce-container">
								<div class="col-6 small-gap">
									<div class="e-commerce-box text-center">
										<a href="https://shopee.co.id/Ultimate-Gentleman-Set-i.322615418.11801059003" target="_blank">
								...
								<div class="col-6 small-gap">
									<div class="e-commerce-box text-center">
										<a href="https://www.tokopedia.com/normid/ultimate-gentleman-set" target="_blank">
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="23" data-price="459000" data-currency="IDR" data-name="Ultimate Gentleman Set" data-url="https://www.norm.id/complete-set/" data-image-url="<?= base_url(); ?>assets/images/main/product/complete-maintenance-set-square.jpg"></div>
		</div>
	</section>
