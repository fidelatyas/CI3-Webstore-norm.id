...
<body>
	<div class="container">
		<div class="banner">
			<img class="width-100" src="https://www.norm.id/assets/images/email/abandon/abandon_1.jpg">
		</div>

		<div class="separator-black">
			<div>Hi <?= $name; ?></div>
			<div>produk favoritmu masih di keranjang</div>
		</div>

		<div class="margin-top-15px">
			<p>Produk favoritmu masih ada di cart tapi belum sampai ke antrean pembayaran.</p>
			<p>Jangan khawatir, produk kamu aman. Cukup klik link di bawah ini untuk menyelesaikan pesananmu.</p>
