	...
	<div class="container">
		<div class="banner">
			<table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; display: block; margin: 0; width: 100%; border-spacing: 0;">
				<tr>
					<td colspan="2">
						<a href="https://www.norm.id/all-product/" target="_blank">
							<img class="width-100" src="https://www.norm.id/assets/images/email/promo/3daysalepromo.jpg" alt="3 day sale">
						</a>
					</td>
				</tr>
			</table>
