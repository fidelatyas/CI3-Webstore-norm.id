...
<body>
				...
				<div class="col-12 col-sm-6 small-gap">
					<div class="image">
						<div class="product-image-carousel owl-carousel owl-theme">
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/ultimate-gift-set-plus-bag-1.jpg">
							</div>
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/ultimate-gift-set-plus-bag-2.jpg">
							</div>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						...
						<div class="description">
							...
							<p>Dapatkan Box Premium dan Water Resistance Utility Bag dari Norm sebagai bentuk hadiah spesial bagi orang yang berada di sekitar kamu.</p>
						</div>
						...
						<div class="bundle-content">
							...
							<div class="bundle-container">
								...
								<div class="fill">
									<div class="image">
										<img class="width-100" src="<?= base_url(); ?>assets/images/main/product/gift-box.jpg">
									</div>
									<div class="content">
						...
						<!-- <div class="button">
							<button class="main width-100 cart-34" onclick="addToCart(34, 0, 1, 799000);">Add to Cart</button>
						</div> -->
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="34" data-price="799000" data-currency="IDR" data-name="Ultimate Gentleman Set" data-url="https://www.norm.id/ultimate-gift-set-plus-bag/" data-image-url="<?= base_url(); ?>assets/images/main/product/ultimate-gift-set-plus-bag-1.jpg"></div>
		</div>
	</section>
