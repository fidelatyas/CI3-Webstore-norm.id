	...
	<section>
		<div class="container margin-top-60px normal">
			...
			<div class="questionaire-button text-center margin-top-30px">
				...
				<div class="margin-bottom-15px">
					<button class="main <? if (isset($arr_answered[0]) && $arr_answered[0]->answer == 'Tidak pernah menggunakan Finasteride'): ?>black<? else: ?>transparent<? endif; ?> questionaire" data-question="Apakah kamu pernah menggunakan Finasteride untuk rambut rontok, paling tidak selama 12 bulan secara konsisten dan memberikan hasil?" data-answer="Tidak pernah menggunakan Finasteride">Tidak pernah menggunakan Finasteride</button>
				</div>
			</div>
		</div>
	</section>
