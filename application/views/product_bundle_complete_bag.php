...
<body>
			...
			<div class="row product-container small-gap margin-top-30px">
				...
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						...
						<div class="yotpo bottomLine margin-top-15px" data-appkey="ZDXRDls8ly8DXaihaUvajdNv4AFIlQSvKN1Ee3zP" data-domain="https://www.norm.id/" data-product-id="26" data-product-models="Bundle" data-name="Ultimate Gentleman Set + Utility Bag" data-url="https://www.norm.id/complete-plus-bag/" data-image-url="<?= base_url(); ?>assets/images/main/product/complete-set-bag-1.jpg" data-description="Miliki berbagai kesempatan baik dengan penampilan yang terawat. Ultimate Gentleman Set adalah pilihan tepat dan lengkap untuk kamu mendapatkan penampilan yang lebih segar dan harum serta wajah bersih yang bersih, cerah, dan tampak lebih muda " data-bread-crumbs="Bundle"></div>
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="26" data-price="659000" data-currency="IDR" data-name="Ultimate Gentleman Set + Utility Bag" data-url="https://www.norm.id/complete-plus-bag/" data-image-url="<?= base_url(); ?>assets/images/main/product/complete-set-bag-1.jpg"></div>
		</div>
	</section>
