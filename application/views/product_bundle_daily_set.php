...
<body>
			...
			<div class="row product-container small-gap margin-top-30px">
				...
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						...
						<div class="yotpo bottomLine margin-top-15px" data-appkey="ZDXRDls8ly8DXaihaUvajdNv4AFIlQSvKN1Ee3zP" data-domain="https://www.norm.id/" data-product-id="30" data-product-models="Bundle" data-name="Daily Maintenance Set" data-url="https://www.norm.id/daily-set/" data-image-url="<?= base_url(); ?>assets/images/main/product/daily-set-1.jpg" data-description="Perawatan wajah harian sangat penting sebelum dan setelah beraktifitas. Daily Maintenance Set adalah kebutuhan harian kamu untuk membantu wajah bebas jerawat, lembab, dan terlihat lebih muda." data-bread-crumbs="Bundle"></div>
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="30" data-price="169000" data-currency="IDR" data-name="Daily Maintenance Set" data-url="https://www.norm.id/daily-set/" data-image-url="<?= base_url(); ?>assets/images/main/product/daily-set-1.jpg"></div>
		</div>
	</section>
