...
<body>
			...
			<div class="row product-container small-gap margin-top-30px">
				<div class="col-12 col-sm-6 small-gap">
					<div class="image">
						<div class="product-image-carousel owl-carousel owl-theme">
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/starter-set-1.jpg">
							</div>
							<div class="item">
				...
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						<h1 class="title">Starter Maintenance Set</h1>

						<div class="yotpo bottomLine margin-top-15px" data-appkey="ZDXRDls8ly8DXaihaUvajdNv4AFIlQSvKN1Ee3zP" data-domain="https://www.norm.id/" data-product-id="29" data-product-models="Bundle" data-name="Complete Shower Set + Utility Bag" data-url="https://www.norm.id/starter-set/" data-image-url="<?= base_url(); ?>assets/images/main/product/starter-set-1.jpg" data-description="Memulai sesuatu yang baru adalah sebuah langkah yang berani. Starter Maintenance Set sebagai langkah awal kamu melakukan perawatan untuk mendapatkan wajah yang bersih dan cerah." data-bread-crumbs="Bundle"></div>

						<div class="price">IDR 159.000</div>

						<div class="description">
							<p>Memulai sesuatu yang baru adalah sebuah langkah yang berani. Starter Maintenance Set sebagai langkah awal kamu melakukan perawatan untuk mendapatkan wajah yang bersih dan cerah.</p>
						</div>
						...
						<!-- <div class="button">
							<button class="main width-100 cart-29" onclick="addToCart(29, 0, 1, 159000);">Add to Cart</button>
						</div> -->
							...
							<div class="row small-gap e-commerce-container">
								<div class="col-6 small-gap">
									<div class="e-commerce-box text-center">
										<a href="https://shopee.co.id/Starter-Maintenance-Set-i.322615418.8741977137" target="_blank">
								...
								<div class="col-6 small-gap">
									<div class="e-commerce-box text-center">
										<a href="https://www.tokopedia.com/normid/starter-maintenance-set" target="_blank">
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="29" data-price="159000" data-currency="IDR" data-name="Complete Shower Set + Utility Bag" data-url="https://www.norm.id/starter-set/" data-image-url="<?= base_url(); ?>assets/images/main/product/starter-set-1.jpg"></div>
		</div>
	</section>
