		...
		<div class="container normal">
			...
			<div class="margin-top-30px row recommendation-prescription-container">
				<div class="col-12 col-sm-4">
					<div class="recommendation-box" style="background-color: #f2f2f2 !important;">
						<div class="image">
				...
				<div class="col-12 col-sm-4">
					<div class="recommendation-box" style="background-color: #f2f2f2 !important;">
						...
						<div class="recommendation-content">
							...
							<div class="price-container margin-top-15px">
								<div class="price-box price-product-13 active" data-product-id="13" data-quantity="1" data-price="269000">
									<div class="checklist">
										<img loading="lazy" src="<?= base_url(); ?>assets/images/main/check.png">
									</div>
									<div>1 bulan perawatan</div>
								...
								<div class="price-box price-product-13" data-product-id="13" data-quantity="3" data-price="269000">
									<div class="checklist">
										<img loading="lazy" src="<?= base_url(); ?>assets/images/main/check.png">
									</div>
									<div class="floating">10% off</div>
