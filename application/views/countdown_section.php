<section class="bg-ececec">
	<div class="container">
		<div class="row countdown-container-program align-items-center">
			<div class="col-12 col-sm-6 countdown-program">
				<div class="title extra-big d-none d-sm-block">MEN DESERVE BETTER</div>
				<div class="title extra-big d-block d-sm-none">MEN DESERVE<br>BETTER</div>
				<div class="title-normal margin-top-15px">
			...
			<div class="col-12 col-sm-6">
				<img class="width-100" src="<?= base_url(); ?>assets/images/main/countdown-section-banner.jpg">
			</div>
		</div>
	</div>
</section>