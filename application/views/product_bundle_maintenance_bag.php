...
<body>
			...
			<div class="row product-container small-gap margin-top-30px">
				<div class="col-12 col-sm-6 small-gap">
					<div class="image">
						<div class="product-image-carousel owl-carousel owl-theme">
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/maintenance-set-bag-1.jpg">
							</div>
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/maintenance-set-bag-2.jpg">
							</div>
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/maintenance-set-bag-3.jpg">
							</div>
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/maintenance-set-bag-4.jpg">
							</div>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						...
						<h1 class="title">Complete Maintenance Set<br>+ Utility Bag</h1>
						<!-- <div class="ingredient">Agave Leaf │ Calendula Flower │ Mugwort</div> -->

						<div class="yotpo bottomLine margin-top-15px" data-appkey="ZDXRDls8ly8DXaihaUvajdNv4AFIlQSvKN1Ee3zP" data-domain="https://www.norm.id/" data-product-id="27" data-product-models="Bundle" data-name="Complete Maintenance Set + Utility Bag" data-url="https://www.norm.id/maintenance-plus-bag/" data-image-url="<?= base_url(); ?>assets/images/main/product/maintenance-set-bag-1.jpg" data-description="Perawatan rutin wajah sangat perlu supaya tetap bersih dan membuatmu terus percaya diri. Complete Maintenance Set adalah pilihan terbaik untuk kulit wajah yang bebas jerawat, cerah, dan lebih muda." data-bread-crumbs="Bundle"></div>
						...
						<div class="description">
							...
							<p>Dapatkan Water Resistance Utility Bag untuk meringkas Complete Maintenance Set dan peralatan lain saat kamu bawa berpergian. Simple, praktis, dan tahan air.</p>
						</div>
						...
						<!-- <div class="button">
							<button class="main width-100 cart-27" onclick="addToCart(27, 0, 1, 469000);">Add to Cart</button>
						</div> -->
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="27" data-price="469000" data-currency="IDR" data-name="Complete Maintenance Set + Utility Bag" data-url="https://www.norm.id/maintenance-plus-bag/" data-image-url="<?= base_url(); ?>assets/images/main/product/maintenance-set-bag-1.jpg"></div>
		</div>
	</section>
