...
<body>
			...
			<div class="row product-container small-gap margin-top-30px">
				...
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						...
						<div class="yotpo bottomLine margin-top-15px" data-appkey="ZDXRDls8ly8DXaihaUvajdNv4AFIlQSvKN1Ee3zP" data-domain="https://www.norm.id/" data-product-id="16" data-product-models="Bundle" data-name="Stamina Cream" data-url="https://www.norm.id/shampoo/" data-image-url="<?= base_url(); ?>assets/images/main/product/stamina-cream-norm.jpg" data-description="Krim anestesi topikal yang dapat digunakan untuk mengatasi ejakulasi dini. Krim ini membantu mengurangi sensitivitas penis, sehingga pria dapat menunda ejakulasi dan berhubungan lebih lama." data-bread-crumbs="Bundle"></div>
	...
	<section class="">
		<div class="container normal">
			<div class="yotpo yotpo-main-widget" data-product-id="16" data-price="249000" data-currency="IDR" data-name="Stamina Cream" data-url="https://www.norm.id/shampoo/" data-image-url="<?= base_url(); ?>assets/images/main/product/stamina-cream-norm.jpg"></div>
		</div>
	</section>
