<nav class="desktop <?= $navbar; ?>">
	<div class="wa-info">
		<div><b>PROMO TERBATAS</b>: DAPATKAN <b>DISKON 10%</b> SAAT MEMESAN KIT KAMI. PROMO BERAKHIR DALAM <span class="digit-nav min"></span>:<span class="digit-nav sec"></span></div>
	</div>
