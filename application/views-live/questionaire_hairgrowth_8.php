	...
	<section>
		<div class="container margin-top-60px normal">
			...
			<div class="margin-top-30px text-center">
				<div class="questionaire-title">Apakah kamu sedang mengalami atau pernah mengalami depresi, kecemasan, atau gangguan panik sebelumnya?</div>
			</div>

			<div class="questionaire-button text-center margin-top-30px">
				<div class="margin-bottom-15px">
					<button class="main <? if (isset($arr_answered[0]) && $arr_answered[0]->answer == 'Ya'): ?>black<? else: ?>transparent<? endif; ?> questionaire" data-question="Apakah kamu sedang mengalami atau pernah mengalami depresi, kecemasan, atau gangguan panik sebelumnya?" data-answer="Ya">Ya</button>
				</div>

				<div class="margin-bottom-15px">
					<button class="main <? if (isset($arr_answered[0]) && $arr_answered[0]->answer == 'Tidak'): ?>black<? else: ?>transparent<? endif; ?> questionaire" data-question="Apakah kamu sedang mengalami atau pernah mengalami depresi, kecemasan, atau gangguan panik sebelumnya?" data-answer="Tidak">Tidak</button>
				</div>
			</div>
		</div>
	</section>
