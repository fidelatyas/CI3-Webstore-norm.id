			...
			<div class="row product-container small-gap margin-top-30px">
				<div class="col-12 col-sm-6 small-gap">
					<div class="image">
						<div class="product-image-carousel owl-carousel owl-theme">
							<div class="item">
								<img class="width-100 margin-bottom-30px" src="<?= base_url(); ?>assets/images/main/product/starter-hair-loss-kit-norm.jpg">
							</div>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-6 small-gap">
					<div class="product-detail-container">
						<h1 class="title">Starter Hair Growth Kit</h1>

						<!-- <div class="price">IDR 279.000</div> -->

						<div class="description">
							<p>Kombinasi perawatan rambut topikal untuk mengurangi kerontokan dan mencegah kebotakan.</p>
						</div>
							...
							<div class="bundle-container">
								...
								<div class="fill">
									...
									<div class="content">
										...
										<div>
											<a class="animate black" href="<?= base_url(); ?>dht-shampoo/">Learn More</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="price-container margin-top-15px">
							<div class="price-box product text-center price-product-13 active" data-product-id="13" data-quantity="1" data-price="279000">
								<div class="checklist">
							...
							<div class="price-box product text-center margin-left-15px price-product-13" data-product-id="13" data-quantity="3" data-price="279000">
								<div class="checklist">
									<img src="<?= base_url(); ?>assets/images/main/check.png">
								</div>
						...
						<div class="button">
							<button class="main width-100 cart-button-13" onclick="prescriptionAddCart(13);">Add to Cart</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container normal">
			...
			<div class="row margin-top-60px">
				<div class="col-12 col-sm-4 text-center">
					<div class="treatment-process">
						<div class="treatment-image">
							<img src="<?= base_url(); ?>assets/images/main/proses-perawatan-1.png">
						</div>
				...
				<div class="col-12 col-sm-4 text-center">
					<div class="treatment-process">
						<div class="treatment-image">
							<img src="<?= base_url(); ?>assets/images/main/proses-perawatan-2.png">
						</div>
				...
				<div class="col-12 col-sm-4 text-center">
					<div class="treatment-process">
						<div class="treatment-image">
							<img src="<?= base_url(); ?>assets/images/main/proses-perawatan-3.png">
						</div>
			...
			<div class="margin-top-60px text-center">
				<button class="main big transparent">Mulai Konsultasi</button>
			</div>
		</div>
	</section>
