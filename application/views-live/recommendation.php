					...
					<div class="col-12 col-sm-3">
						<div class="account-left-menu">
							<a href="<?= base_url(); ?>account/" class="list">
								<div class="icon">
									<img src="<?= base_url(); ?>assets/images/main/my-account-icon.png">
								</div>
								<div class="text">My Details</div>
							</a>
							<a href="<?= base_url(); ?>medical-grade/" class="list">
								<div class="icon">
									<img src="<?= base_url(); ?>assets/images/main/order-icon.png">
								</div>
								<div class="text">Order</div>
							</a>
							<a href="<?= base_url(); ?>account/recommendation/" class="list active">
								<div class="icon">
									<img src="<?= base_url(); ?>assets/images/main/recommendation-icon.png">
								</div>
								<div class="text">My Recommendation</div>
							</a>
							<a href="<?= base_url(); ?>account/history/" class="list">
								<div class="icon">
									<img src="<?= base_url(); ?>assets/images/main/history-icon.png">
								</div>
								<div class="text">Order History</div>
							</a>
							<a onclick="signOut();" class="list">
								<div class="icon">
									<img src="<?= base_url(); ?>assets/images/main/logout-icon.png">
								</div>
								...
								<? foreach ($arr_consultation as $k => $consultation): ?>
									<div class="consultation-detail <? if ($k <= 0): ?>active<? endif; ?> consultation-<?= $consultation->id; ?>">
										<div class="recommendation-doctor-container">
											<div class="image">
												<img src="<?= base_url(); ?>assets/images/main/dr-rahma.png">
											</div>
											<div class="detail">
																...
																<? elseif($product_id == 4): ?>
																	<div class="product-box">
																		...
																		<div class="detail">
																			...
																			<div class="description">Sampo yang dapat mengurangi kadar DHT pada kulit kepala penyebab masalah kerontokan rambut.</div>

																			<div class="margin-top-7-5px">
																				<!-- <button class="main black small cart-4" onclick="addToCart(4, 5, 1, 129000);">Add to Cart</button> -->
														...
														<? foreach ($consultation->arr_product as $product_id): ?>
															<div class="col-12 col-sm-6">
																<? if ($product_id == 16): ?>
																	<div class="product-box">
																		<div class="image">
																			<img src="<?= base_url(); ?>assets/images/main/product/stamina-cream-norm.png">
																		</div>
																		<div class="detail">
