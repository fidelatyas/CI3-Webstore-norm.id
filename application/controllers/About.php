...
class About extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $metatag->title = 'Personal care khusus pria | Norm';
        $metatag->description = 'Personal care khusus pria yang menyediakan produk skincare, hair care, body care, dan parfum.';
