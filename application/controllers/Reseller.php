...
class Reseller extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $metatag->title = 'Norm membuka peluang reseller | Norm';
        $metatag->description = 'Norm membuka peluang untuk siapapun yang ingin menjadi reseller. Norm juga akan memberikan pembinaan dan benefit untuk para reseller.';
        ...
        $this->load->view('reseller', $arr_data);
    }
    ...
    public function register()
    {
        ...
        $this->load->view('reseller_registration', $arr_data);
    }
    ...
    public function thankyou()
    {
        ...
        $this->load->view('reseller_thankyou', $arr_data);
    }
