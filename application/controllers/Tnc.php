...
class Tnc extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $metatag->title = 'Terms and Conditions - Norm';
        $metatag->description = 'Temukan informasi syarat dan ketentuan seputar produk dan layanan dari Norm nya di sini.';
