...
class Privacy extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $metatag->title = 'Privacy Policy - Norm';
        $metatag->description = 'Temukan informasi kebijakan privasi seputar produk dan layanan dari Norm nya di sini.';
        ...
        $this->load->view('privacy', $arr_data);
    }
