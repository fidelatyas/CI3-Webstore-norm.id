...
class Ads extends CI_Controller
{
    ...
    public function shampoo()
    {
        ...
        $metatag->title = 'Perawatan rambut untuk mencegah dari kerontokan | Norm';
        $metatag->description = 'Produk perawatan rambut yang mencegah kerontokan serta menguatkan akar dan menebalkan rambut.';
        ...
        $this->load->view('ads_shampoo', $arr_data);
    }
    ...
    public function skincare()
    {
        ...
        $metatag = new stdClass();
        $metatag->title = 'Rangkaian perawatan kulit wajah khusus pria | Norm';
        $metatag->description = 'Rangkaian perawatan kulit wajah khusus pria untuk menghilangkan masalah kulit pada wajah.';
        $metatag->robot = 'all, notranslate';
        $metatag->googlebot = 'all, notranslate';
        $metatag->og_type = 'website';
        $metatag->og_image = '';
        ...
        $this->load->view('ads_skincare', $arr_data);
    }
